<?php 
        ...
        $gpa = !empty($gpa) ? "'$gpa'" : "NULL";
        $level = !empty($level) ? "'$level'" : "NULL";
       

         if(isset($_POST["submit"])) 
         {
         $query_check="SELECT email from student WHERE email='$email'";
 ...
 $query_Registerr = "INSERT INTO student (id_student , first_name , last_name , email , phone, gender, major, level , gpa, password, repassword ) VALUES ('$id_student', NULL, NULL, '$email', NULL, NULL, NULL, NULL , NULL, '$password', '$repassword')";
...
<div class="row">
<div class="col-md-10 ">
<form class="form-horizontal" method="post" action="reg_student1.php">
<fieldset>
...
<label class="col-md-4 control-label" for="ID">ID</label>  
  <div class="col-md-4"> 
       ...
       <input id="id_student" name="id_student" type="id_student" placeholder="ID" class="form-control input-md">
      </div>
  </div>
</div>
