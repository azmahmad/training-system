<?php 
        ...
        $repassword = isset($_POST[ "repassword" ]) ? $_POST[ "repassword" ] : "";
         ...
         $query_check="SELECT email from supervisor WHERE email='$email'";
 ...
 $query_Register = "INSERT INTO supervisor (id_supervisor , first_name , last_name , email , phone, department , password, repassword) VALUES ('".$_POST["id_supervisor"]."','".$_POST["first_name"]."','".$_POST["last_name"]."','".$_POST["email"]."','".$_POST["phone"]."','".$_POST["department"]."','".$_POST["password"]."','".$_POST["repassword"]."')";
...
<div class="row">
<div class="col-md-10 ">
<form class="form-horizontal" method="post" action="reg_supervisor.php">
<fieldset>
...
<label class="col-md-4 control-label" for="ID">ID</label>  
  <div class="col-md-4"> 
       ...
       <input id="id_supervisor" name="id_supervisor" type="id_supervisor" placeholder="ID" class="form-control input-md">
      </div>
  </div>
</div>
